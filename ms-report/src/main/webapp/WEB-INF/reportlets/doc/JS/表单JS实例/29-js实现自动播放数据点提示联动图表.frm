...
<TableData name="图表" class="com.fr.data.impl.DBTableData">
<Parameters>
<Parameter>
...
<Query>
<![CDATA[SELECT * FROM 地图
where 1=1
${if(len(area)=0,""," and pid='"+area+"'")}]]></Query>
<PageQuery>
<![CDATA[]]></PageQuery>
</TableData>
</TableDataMap>
...
<Attributes>
<![CDATA[=sql("FRDemo","SELECT distinct pid FROM 地图 where pid!=''",1)]]></Attributes>
</O>
</Parameter>
</Parameters>
<Content>
<![CDATA[window.area = area;
window.temp = 0;
var len = window.area.length;
var temp = 0;
setTimeout(function() {
	var vanchart = FR.Chart.WebUtils.getChart('地图').vanCharts.charts[0]A;
	var series = vanchart.series,
		allPoints = []A;
	/* 获取chart下的所有系列和所有数据点 */
	for (var i = -1; ++i < series.length;) {
		allPoints = allPoints.concat(series[i]A.points);
	}
	...
	setInterval(function() {
		...
		FR.Chart.WebUtils.changeParameter(
			'饼图', {
				"area": window.area[window.temp]A
			}
		);
		/*刷新柱形图*/
		FR.Chart.WebUtils.changeParameter(
		...
		for (var j = 0; j < allPoints.length; j++) {
			if (allPoints[j]A.name == window.area[window.temp]A) {
				/* 使用vanchart.showTooltip展示数据点 */
				vanchart.showTooltip(allPoints[j]A);
			}
		}
...
<BoundsAttr x="592" y="0" width="368" height="270"/>
</Widget>
...
<BoundsAttr x="592" y="270" width="368" height="270"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
<WidgetName name="饼图"/>
...
<ChartDefinition>
<OneValueCDDefinition seriesName="省份" valueName="销售额" function="com.fr.data.util.function.SumFunction">
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[图表]]></Name>
...
<BoundsAttr x="0" y="0" width="592" height="540"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
...
<TemplateIdAttMark TemplateId="3355f475-b2b1-4eea-8665-7b9c7ba9722c"/>
</TemplateIdAttMark>
</Form>

...
<BoundsAttr x="0" y="256" width="375" height="177"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<O t="Formula" class="Formula">
<Attributes>
<![CDATA[="<table  align='center' width='98%' border=0 cellspacing=0 cellpadding=0 height='7'><tr> <td  style='border-radius:5px' bgcolor='" + if(ROUND(F2 * 100, 2) > 100, "#00A65A ", if(ROUND(F2 * 100, 2) > 80, "#4CD1FF", if(ROUND(F2 * 100, 2) > 60, "#F39C12", "#749CF4"))) + "' width='" + F2 * 100 + "%'></td> <td bgcolor='#666666'  style='border-top-right-radius:5px;border-bottom-right-radius:5px' width='" + (100 - F2 * 100) + "%'></td></tr> </table>"]]></Attributes>
</O>
<PrivilegeControl/>
...
<HighlightAction class="com.fr.report.cell.cellattr.highlight.BorderHighlightAction">
<Border topLine="0" topColor="-16777216" bottomLine="1" bottomColor="-13618348" leftLine="0" leftColor="-16777216" rightLine="0" rightColor="-16777216"/>
</HighlightAction>
</Highlight>
</HighlightList>
<Expand/>
...
<BoundsAttr x="0" y="433" width="375" height="28"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="0" y="461" width="375" height="19"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
<WidgetName name="chart1"/>
...
<BoundsAttr x="0" y="78" width="375" height="178"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList>
...
<TemplateID TemplateID="2fe67388-26e5-409f-99b5-0565739902c9"/>

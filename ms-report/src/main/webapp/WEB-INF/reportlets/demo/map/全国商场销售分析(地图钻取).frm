...
<Query>
<![CDATA[SELECT * FROM 地图1 where 1=1 ${if(len(province) = 0||province=='中国'," order by 销售额 desc","and pid='"+province+"'")} ]]></Query>
<PageQuery>
<![CDATA[]]></PageQuery>
</TableData>
...
<Attributes>
<![CDATA[="  " + if(len($province) = 0 || $province = "中国", "全国数据", $province + "数据")]]></Attributes>
</O>
<PrivilegeControl/>
...
<O t="XMLable" class="com.fr.base.Formula">
<Attributes>
<![CDATA[=if(len($province) = 0 || $province = "中国", nofilter, $province)]]></Attributes>
</O>
</Compare>
</Condition>
<Complex/>
...
<Formula>
<![CDATA[len($province) = 0 || $province = "中国"]]></Formula>
</Condition>
...
<O t="XMLable" class="com.fr.base.Formula">
<Attributes>
<![CDATA[="  " + if(len($province) = 0 || $province = "中国", "全国下属地区数据", $province + "下属地区数据")]]></Attributes>
</O>
<PrivilegeControl/>
<CellGUIAttr adjustmode="0"/>
<CellPageAttr/>
...
<TextAttr>
<Attr alignText="0">
<FRFont name="Adobe Arabic" style="0" size="96" foreground="-5066062"/>
</Attr>
</TextAttr>
<backgroundinfo>
<GI>
